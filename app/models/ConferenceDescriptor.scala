...
object ConferenceDescriptor {
  ...
  object ConferenceProposalTypes {
    ...
    val EITHER = ProposalType(id = "d_either", label = "either.label")
    ...
    val ALL = List(CONF, QUICK, EITHER, WORKSHOP)
  ...
  def current() = ConferenceDescriptor(
    ...
    timing = ConferenceTiming(
      ...
      cfpOpenedOn = DateTime.parse("2018-12-10T00:00:00+01:00"),
      cfpClosedOn = DateTime.parse("2019-01-21T23:59:59+01:00"),
