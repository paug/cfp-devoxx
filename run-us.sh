...
export SMTP_USER="dfdad33e6f4f57fd423af25b68c4f7fb"
...
export REDIS_PORT="6969"
export REDIS_PASSWORD=''

export CRON_UPDATER="true"
export CRON_DAYS="2"

export ES_ADDON_URI="http://localhost:9200"
export ES_ADDON_USER="ub9cIbJbh"
export ES_ADDON_PASSWORD="ir71Me1AWPBGpu8dcKl"
...
export ACTIVATE_HTTPS="true"
export ACTIVATE_FAVORITES="false"
export ACTIVATE_VOTE="true"

export BUCKET_ROOTFOLDER="/Users/nicolas/Dev/DevoxxFR/2016/save_be_program_2015/cfp.devoxx.be"
